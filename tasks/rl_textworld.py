...
if __name__ == "__main__":
    ...
    if args.q_learning:
        ...
        rl_core = Model(input_size=MAX_VOCAB_SIZE, network_preset=Network_Scale_Preset(args.scale), device=device, discount_factor=0.97, learning_rate=0.000002, epsilon_greedy=0.1, train_temperature=1.0)
    else:
